...
QT_MOC_LITERAL(1, 12, 15), // "changeTimeLabel"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "finished"
QT_MOC_LITERAL(4, 38, 9) // "onTimeout"

    },
    "TimeCounter\0changeTimeLabel\0\0finished\0"
    "onTimeout"
};
...
void TimeCounter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TimeCounter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeTimeLabel(); break;
        ...
        {
            using _t = void (TimeCounter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeCounter::changeTimeLabel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TimeCounter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeCounter::finished)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TimeCounter::staticMetaObject = { {
    ...
    qt_meta_stringdata_TimeCounter.data,
    qt_meta_data_TimeCounter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void TimeCounter::changeTimeLabel()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TimeCounter::finished()
{
